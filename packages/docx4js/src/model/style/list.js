import NumberingDefinition from './numberingDefinition';
...
export default class List extends Style {
  ...
  getParentStyle() {
    var definition = this.wDoc.style.get(NumberingDefinition.asStyleId(this.wXml.$1('abstractNumId').attr('w:val')));
    if (definition.link) {
